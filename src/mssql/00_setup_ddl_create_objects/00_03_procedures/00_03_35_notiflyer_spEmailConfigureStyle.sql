if object_id('notiflyer_spEmailConfigureStyle') is not null
    print 'notiflyer_spEmailConfigureStyle stored procedure exists, skipping create attempt..'
    print 'ignore error below, cannot create exception handling on ddl statements'
    return;
go

-- drop procedure notiflyer_spEmailConfigureStyle
create procedure notiflyer_spEmailConfigureStyle
/*
    @author     cleancoda
    @date       12122023
    @detail     
    @sample
                ...
                exec notiflyer_spEmailConfigureStyle
                    ,@returnvalue = 0
                    ,@returnmessage = ''
